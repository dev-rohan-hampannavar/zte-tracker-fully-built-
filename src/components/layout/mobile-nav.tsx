      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-64 glass-panel border-l border-border p-3 flex flex-col overflow-y-auto"
          >
                    ...
                    {items.map(({ href, label, icon: Icon }) => {
                      ...
                      return (
                        <Link
                          ...
                          onClick={() => setOpen(false)}
                          className={cn(
                            "flex items-center gap-2.5 rounded-md px-3 py-2.5 text-sm font-medium transition-standard",
                            active
                              ? "bg-accent/15 text-accent shadow-[inset_0_0_0_1px_rgba(99,102,241,0.15)]"
