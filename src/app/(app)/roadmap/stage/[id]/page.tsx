      ...
      <div>
        ...
        <div className="flex items-center gap-3 mt-3">
          <div className="flex items-center gap-2 max-w-xs flex-1">
            <Progress value={pct(completedCount, topics.length)} className="h-1.5 flex-1" glow={topics.length > 0 && completedCount === topics.length} />
            ...
            {topics.map((topic) => {
              ...
              return (
                ...
                <Link href={`/roadmap/topic/${topic.id}`}>
                  <div className="flex items-center gap-3 rounded-md px-2 py-2 hover:bg-surface-2 transition-standard glow-card">
                    <Checkbox
                      checked={!!p?.completed}
