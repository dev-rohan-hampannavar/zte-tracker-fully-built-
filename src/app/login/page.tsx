...
function LoginForm() {
  ...
  return (
    <main className="min-h-screen bg-background bg-mesh px-4 py-10 flex items-center justify-center">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-10 items-center">
        ...
        <FadeUp className="flex flex-col gap-6 order-2 lg:order-1">
          <div>
            ...
            <h1 className="text-2xl font-semibold tracking-tight leading-snug text-gradient-accent">
          ...
          <p className="text-xs text-muted/70 leading-relaxed">
            ...
            works, the realistic timeline? That&apos;s on the welcome tour, linked below the sign-in
            form. This is the pitch for the tool you&apos;re about to sign into.
          </p>
        </FadeUp>

        {/* Sign-in form */}
        <FadeUp delay={0.15} className="w-full max-w-sm mx-auto lg:mx-0 order-1 lg:order-2">
          <Card className="border-accent/20 glow-card">
            <CardHeader>
          ...
          <Button variant="outline" className="w-full mt-3" asChild>
            <Link href="/welcome">See the welcome tour</Link>
          </Button>
        </FadeUp>
      </div>
    </main>
