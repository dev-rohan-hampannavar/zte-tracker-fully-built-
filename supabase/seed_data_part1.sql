...
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('02', 'React + Next.js Core', '6–9', '146', '213', 'Foundation', 'Frontend Core', 2);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('03', 'UI System & Styling', '10–12', '141', '135', 'Foundation', 'Frontend Core', 3);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('04', 'State, Data Fetching & Advanced React', '13–16', '169', '153', 'Core', 'Frontend Core', 4);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('05', 'Backend + Database + Auth', '17–22', '229', '314', 'Core', 'Backend', 5);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('06', 'Testing + CI/CD + Deployment', '23–27', '182', '155', 'Core', 'Infra & DevOps', 6);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('06b', 'React Native (Mobile) — Optional', 'concurrent w/ 07', '—', '111', 'Core', 'Mobile (Optional)', 7);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('07', 'API Documentation & Developer Tooling', '28', '68', '71', 'Core', 'Backend', 8);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('08', 'DSA & Interview Preparation', '29–32', '160', '331', 'Core', 'Interview Prep', 9);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('09', 'Caching + Email + Payments', '33–34', '86', '98', 'Advanced', 'Backend', 10);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('10', 'Monitoring + Product Analytics', '35–39', '179', '103', 'Advanced', 'Infra & DevOps', 11);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('11', 'Real-Time + Search + PostgreSQL Internals', '40–43', '167', '164', 'Advanced', 'Backend', 12);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('12', 'AI/RAG + Production AI Patterns', '44–47', '172', '207', 'Advanced', 'AI/ML', 13);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('13', 'Advanced Browser APIs + Collaboration', '48–51', '152', '137', 'Advanced', 'Frontend Core', 14);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('14', 'Load Testing + Security Deep Dive', '52–54', '119', '89', 'Advanced', 'Infra & DevOps', 15);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('15', 'Build Tooling + CSS-in-JS', '55–56', '70', '44', 'Advanced', 'Frontend Core', 16);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('16', 'Infrastructure', '57–58', '100', '175', 'Expert', 'Infra & DevOps', 17);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('17', 'Architectural Patterns', '59–62', '161', '178', 'Expert', 'Backend', 18);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('18', 'Engineering Craft + Package Publishing', '63–66', '136', '62', 'Expert', 'Career & Craft', 19);
insert into public.master_phase_table (phase, focus, weeks, header_hours, realistic_hours, band, track, order_index) values ('19', 'Career & Community', '67–68', '68', '29', 'Expert', 'Career & Craft', 20);
...
insert into public.program_total (id, original_stated, raw_bottom_up_sum, realistic_total, net_change) values (1, '2,700 hours', '2,461 hours', '3034 hours', '+334 hours (+12%)')
on conflict (id) do update set original_stated=excluded.original_stated, raw_bottom_up_sum=excluded.raw_bottom_up_sum, realistic_total=excluded.realistic_total, net_change=excluded.net_change;
...
* **Follows it:** Exit ★ 1 unlocked (Series A/B startups, product companies) — then Phases 09 onward build production-grade breadth (caching, payments, monitoring, real-time, AI, infra, architecture).', '["Phases 01, 01b, 02, 03, 04, 05, 06 — in that order — reach Exit A at ~6.1 months (@40 hrs/wk).", "Everything from Phase 07 onward extends the profile toward higher exits (B, ★ 1, C, ★ 2, D, 3, E) — not required to start applying."]'::jsonb)
...
insert into public.month_by_month (month, phases_active, focus, realistic_hours, order_index) values ('—', '06b', 'React Native (Mobile) — Optional', '111h', 7);
...
insert into public.phase_checklist (phase, title, hours, weeks, order_index) values ('06b', 'React Native (Mobile) — Optional', '111h', 'weeks concurrent w/ 07', 7);
