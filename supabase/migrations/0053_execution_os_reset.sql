-- Keep the canonical progress reset complete as new Execution OS tables are
-- introduced. Planning commitments, time blocks, and evidence are progress
-- artifacts and are cleared; the financial profile is intentionally kept as
-- personal settings rather than learning progress.
